...
#define ADDR_FLASH_PAGE_480  ((uint32_t)0x0801E000) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_481  ((uint32_t)0x0801E100) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_482  ((uint32_t)0x0801E200) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_483  ((uint32_t)0x0801E300) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_484  ((uint32_t)0x0801E400) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_485  ((uint32_t)0x0801E500) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_486  ((uint32_t)0x0801E600) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_487  ((uint32_t)0x0801E700) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_488  ((uint32_t)0x0801E800) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_489  ((uint32_t)0x0801E900) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_490  ((uint32_t)0x0801EA00) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_491  ((uint32_t)0x0801EB00) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_492  ((uint32_t)0x0801EC00) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_493  ((uint32_t)0x0801ED00) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_494  ((uint32_t)0x0801EE00) /* Base @ of Page 64, 256 bytes */
#define ADDR_FLASH_PAGE_495  ((uint32_t)0x0801EF00) /* Base @ of Page 64, 256 bytes */
/* Exported macro ------------------------------------------------------------*/

#define DEVICE_ID_ADDR  ((uint32_t)0x0800F000) /* Base @ of Page 64, 256 bytes */
#define DEVICE_IP_ADDR  ((uint32_t)0x0800F300)
#define DEVICE_WK_ADDR  ((uint32_t)0x0800F500) /* Base @ of Page 64, 256 bytes */
